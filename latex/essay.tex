...
\begin{algorithm}[!ht]
  ...
  \begin{algorithmic}[1]
    ...
    \Procedure{NaïveUpdate}{$\G^{t+1}, \W^t, \V^1_{\text{affected}}, \gamma, l$}
    \LineComment{Initialise $\gamma$ new walks from each of the affected vertices in $\V^1_{\text{affected}}$}
    \State $\W$ \leftarrow initWalks($\V^1_{\text{affected}}, \gamma$)
