...
SinOne option for this is to simply recalculate all of the vertex representations,
however this would be very inneficient since it is possible to use the previous
representations, since the new representations will be very similar if only a
small portion of the graph structure has been changed. 
