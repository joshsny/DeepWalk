...
well as this, since $P$ is irreducible and thus positive recurrentasince the
...
If we set $i_1, i_2, \dots$ to be the times of successive visits of $Z$ to $v$ and $Y_k = \mathbbm{1}(Z_{i_k+1} = c)$, then the $(Y_k)_{k \geq 1}$ are i.i.d, so we can apply the proposition.
