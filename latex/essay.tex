...
Here I exhibit a proof that SkipGram with Negative Sampling is equivalent to factorising a
certain matrix $M$ into two smaller matricies $W$ and $C$ where the rows in $W$
correspond to the learned embedding of each vertex. This result was first proved by Levy and
...
$(v,c)$, vertex $v$ and context $c$ appear in the random-walks corpus
